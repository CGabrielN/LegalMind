...
class RetrievalEvaluator:
    ...
    @staticmethod
    def calculate_retrieval_precision(query: str, retrieved_docs: List[Dict[str, Any]], relevant_docs: List[Dict[str, Any]]) -> float:
        """
        ...
        logger.info(f"Retrieval precision for query '{query[:30]}...': {precision:.4f}")
        return precision

    @staticmethod
    def calculate_retrieval_recall(retrieved_docs: List[Dict[str, Any]],
    ...
    def evaluate_retrieval(self, query: str, retrieved_docs: List[Dict[str, Any]],
                           relevant_docs: Optional[List[Dict[str, Any]]] = None) -> Dict[str, float]:
        """
...
class ResponseEvaluator:
    ...
    @staticmethod
    def calculate_citation_accuracy(response: str, reference_citations: List[str]) -> float:
        """
        ...
        if not reference_citations:
            return 1.0 if count_citations(response) == 0 else 0.0
    ...
    @staticmethod
    def check_for_hallucinations(response: str, context: str) -> Tuple[bool, List[str]]:
        """
    ...
    def evaluate_response(self, response: str, reference_answer: Optional[str] = None, context: Optional[str] = None,
                          reference_citations: Optional[List[str]] = None) -> Dict[str, Any]:
        """
        ...
        """
        # Count citations
        results = {"citation_count": count_citations(response)}
...
class LegalMindEvaluator:
    ...
    def evaluate_full_pipeline(self, query: str, retrieved_docs: List[Dict[str, Any]], response: str, context: str,
        ...
        # Evaluate response
        response_results = self.response_evaluator.evaluate_response(response, reference_answer, context,
                                                                     reference_citations)
